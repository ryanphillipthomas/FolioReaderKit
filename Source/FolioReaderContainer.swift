...
open class FolioReaderContainer: UIViewController {
    ...
    public init(withConfig config: FolioReaderConfig, folioReader: FolioReader, epubPath path: String, unzipPath: String? = nil, removeEpub: Bool = true, chapters: [ZOFolioChapter], isDRM: Bool = false) {
    ...
    fileprivate func initialization() {
        ...
        self.folioReader.register(defaults: [
            kCurrentFontFamily: FolioReaderFont.clifford.rawValue,
            kNightMode: false,
            kCurrentFontSize: 2,
            kCurrentAudioRate: 1,
