...
open class FolioReaderPage: UICollectionViewCell, WKNavigationDelegate, UIGestureRecognizerDelegate {
    ...
    public override init(frame: CGRect) {
        ...
        self.readerContainer = FolioReaderContainer(withConfig: FolioReaderConfig(), folioReader: FolioReader(), epubPath: "", chapters: [ZOFolioChapter]())
    ...
    open func scrollPageToOffset(_ offset: CGFloat, animated: Bool) {
        ...
        DispatchQueue.main.async {
            self.webView?.scrollView.setContentOffset(pageOffsetPoint, animated: true)
        }
    }
